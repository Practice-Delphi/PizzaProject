...
import '../Sign_in_Sell/Sign_in_Sell.css';
import Header from '../../Header/Header'



class SignInCast extends Component{
    constructor(props) {
        super(props);
        this.state = {
            userName: null,
...
export default connect(mapStateToProps, mapDispatchToProps)(SignInCast);